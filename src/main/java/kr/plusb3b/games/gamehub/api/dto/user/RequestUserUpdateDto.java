...
public class RequestUserUpdateDto {
    ...
    public RequestUserUpdateDto(String authUserId, String authPassword, String priEmail, LocalDate priBirth,
                                String mbNickName, String mbStatusMessage, String priGender) {
